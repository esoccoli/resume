...
\cvevent{Brick Breaker}{C\#, Monogame, .NET Core, Visual Studio}{September 2022 - Present}{\github{esoccoli/BrickBreaker}}
\begin{itemize}
...
\cvevent{NewUHC}{Java, Kotlin, PaperMC, IntelliJ IDEA}{December 2022 - Present}{\github{esoccoli/NewUHC}}
\begin{itemize}
...
\cvevent{Space Invader}{C\#, Monogame, .NET Core, Visual Studio}{December 2022 - Present}{\github{esoccoli/SpaceInvader}}
\begin{itemize}
...
\cvevent{Personal Website}{HTML, CSS, JavaScript, Bootstrap, Github Pages}{January 2023 - Present}{\github{esoccoli/esoccoli.github.io}}
\begin{itemize}
